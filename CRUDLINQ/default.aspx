<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="CRUDLINQ._default" %>
 ...
 <div class="container">
     ...
     <div class="row">
         <div class="col align-self-end">
             <asp:Button runat="server" ID="BtnCreate" CssClass="btn btn-success form-control-sm btn" Text="crear" Onclick="Btncrear_Click" />
         </div>
     </div>
 </div>
 <br />
        ...
        <asp:GridView runat="server" ID="gvusuarios" Class="table table-borderless table-hover">
            <Columns>
                <asp:TemplateField HeaderText="opciones del administrador">
                    <ItemTemplate>
                        <asp:Button runat="server" Text="Mostrar" CssClass="btn form-control-sm btn-primary" ID="btnRead" OnClick="btnRead_Click"/>
                        <asp:Button runat="server" Text="Actualizar" CssClass="btn form-control-sm btn-primary" ID="btnActualizar" OnClick="btnActualizar_Click"/>
